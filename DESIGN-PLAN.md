...
- [ ] **D5.4 Performance & responsive pass**: Lighthouse ≥90 on dashboard, CLS <0.05, INP <200ms; test at 360px, 768px, 1024px, 1440px; font loading without FOUT; image/receipt lazy loading.
  ...
  - **Not done: the mobile-preset Performance score is 62 / 72 / 72 against ≥90** — 500–600 KB of script on simulated slow-4G, including 70 KB that ships unminified. INP is unmeasured (needs a DevTools interaction trace), and the 360/768/1024/1440 walkthrough is only covered at two widths by the screenshot baseline.
