...
// Complaint thread error boundary (D5.1). Its own, because the useful recovery here is
...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useErrorReport(error, "complaints/[id]");

  return (
    <RouteError
      headline="Couldn't load this complaint"
      reset={reset}
      backHref="/complaints"
